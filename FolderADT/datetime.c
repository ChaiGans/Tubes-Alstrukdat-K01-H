...
void displayDATETIME (DATETIME receiveTime) {
    printf("%02d/%02d/%04d %02d:%02d:%02d", Day(receiveTime), Month(receiveTime), Year(receiveTime), Hour(Time(receiveTime)), Minute(Time(receiveTime)), Second(Time(receiveTime))); 
}
